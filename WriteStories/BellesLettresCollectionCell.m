...
@interface BellesLettresCollectionCell ()

@property (nonatomic, strong) FLAnimatedImageView *flImageView;

@end

@implementation BellesLettresCollectionCell
...
- (void)buildViewsOnAreaView:(UIView *)view {
    ...
    self.flImageView.animatedImage = [FLAnimatedImage animatedImageWithGIFData:[NSData dataWithContentsOfFile:absoluteFilePathFrom(@"-/pic_3_use_ver2.gif")]];
}
