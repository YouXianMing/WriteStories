...
@implementation Block_picture_normal_3
...
+ (instancetype)defalutObject {
    ...
    Block_picture_normal_3 *item = [Block_picture_normal_3 new];
...
- (instancetype)currentStyleObject {
    ...
    Block_picture_normal_3 *object = (Block_picture_normal_3 *)[BaseBlockItem decodeWithData:self.encodeData];
...
- (void)useStyleObject:(id)styleObject {
    ...
    Block_picture_normal_3 *style = styleObject;
...
- (NSString *)htmlString {
    ...
    [div appendFormat:@"<p %@ %@ %@>%@</p>",
     ...
     _html_style(FmtStr(@"max-width: %@%%; padding-bottom: %@px; font: normal 400 %@px %@; color: %@;",
                        self.widthPercent,
                        self.gap,
                        self.titleFontSize,
                        self.titleFontName,
...
- (NSString *)jsonConfigWithDebug:(BOOL)debug {
    ...
    [manager.subs addObject:jsConfig(@"title",
                                     ...
                                     FmtStr(@"max-width: %@%%; padding-bottom: %@px; font: normal 400 %@px %@; color: %@;",
                                            self.widthPercent,
                                            self.gap,
                                            self.titleFontSize,
                                            self.titleFontName,
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [self autoEncodePropertiesWithCoder:aCoder class:Block_picture_normal_3.class];
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self = [super initWithCoder:aDecoder]) {
        ...
        [self autoDecoderPropertiesWithDecoder:aDecoder class:Block_picture_normal_3.class];
    }
