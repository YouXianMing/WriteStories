...
@implementation Block_subtitle_colorblock_2
...
- (ItemsStyleEditManager *)editManager {
    ...
    {
        // 右边线条
        ItemsHeader *header = [ItemsHeader headerWithTitle:@"右边线条"];
        [manager.headers addObject:header];
...
+ (instancetype)defalutObject {
    ...
    Block_subtitle_colorblock_2 *item = [Block_subtitle_colorblock_2 new];
...
- (instancetype)currentStyleObject {
    ...
    Block_subtitle_colorblock_2 *object = (Block_subtitle_colorblock_2 *)[BaseBlockItem decodeWithData:self.encodeData];
...
- (void)useStyleObject:(id)styleObject {
    ...
    Block_subtitle_colorblock_2 *style = styleObject;
...
- (NSString *)htmlString {
    ...
    [div appendFormat:@"<span %@ %@ %@>%@</span>",
     _html_tag(@"title"),
     _html_class(@" "),
     _html_style(FmtStr(@"font: normal 400 %@px %@; color: %@; opacity: %@; border-left:%@px %@ %@; border-right: %@px %@ %@; padding: 0px %@px 0px %@px;",
...
- (NSString *)jsonConfigWithDebug:(BOOL)debug {
    ...
    [manager.subs addObject:jsConfig(@"title", @" ", FmtStr(@"font: normal 400 %@px %@; color: %@; opacity: %@; border-left:%@px %@ %@; border-right: %@px %@ %@; padding: 0px %@px 0px %@px;",
                                                self.titleFontSize, self.titleFontName, self.titleHexColor, self.titleOpacity, self.leftBorderWidth, self.leftBorderStyle, self.leftBorderColor,
                                                self.rightBorderWidth, self.rightBorderStyle, self.rightBorderColor, self.wordGap, self.wordGap))];
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [self autoEncodePropertiesWithCoder:aCoder class:Block_subtitle_colorblock_2.class];
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self = [super initWithCoder:aDecoder]) {
        ...
        [self autoDecoderPropertiesWithDecoder:aDecoder class:Block_subtitle_colorblock_2.class];
    }
