...
@implementation Paper_6

- (void)config_js_WithOutterAndInnerDivs:(OutterAndInnerDivs *)divs {
    
    divs.inner_2_class = @"pa h_100 w_100 z_n2 bsbb bss";
    divs.inner_2_style = @"-webkit-border-image: url(../../../images/edgePatternImages/典雅6.png) 202 298 202 298 repeat; border-width: 76px 112px 76px 112px;";
}
...
- (void)config_htmlString_WithOutterAndInnerDivs:(OutterAndInnerDivs *)divs {
    ...
    divs.inner_2 = FmtStr(@"<div %@ %@ %@></div>",
                          ...
                          _html_style(@"-webkit-border-image: url(../../../images/edgePatternImages/典雅6.png) 202 298 202 298 repeat; border-width: 76px 112px 76px 112px;"));
}
