...
+ (instancetype)defalutObject {
    ...
    Folder_city *item = [Folder_city new];
    
    // cell相关
    item.cellReuseId     = @"Folder_city";
    item.cellClassString = @"Folder_city_cell";
...
- (instancetype)currentStyleObject {
    ...
    Folder_city *object = (Folder_city *)[BaseFolderItem decodeWithData:self.encodeData];
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [self autoEncodePropertiesWithCoder:aCoder class:Folder_city.class];
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self = [super initWithCoder:aDecoder]) {
        ...
        [self autoDecoderPropertiesWithDecoder:aDecoder class:Folder_city.class];
    }
