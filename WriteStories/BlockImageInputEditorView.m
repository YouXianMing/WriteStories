...
@interface BlockImageInputEditorView () <UIImagePickerControllerDelegate, UINavigationControllerDelegate, CustomViewControllerDelegate>
...
@implementation BlockImageInputEditorView
...
- (void)baseCustomViewController:(__kindof CustomViewController *)controller event:(id)event {
    ...
    EncodeImageObject *imageObject = [self.inputEdior valueWithObject:self.weakObject];
    NSString *imagePath            = [NSString stringWithFormat:@"%@/block/%@",
