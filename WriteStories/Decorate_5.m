...
- (void)config_htmlString_WithOutterAndInnerDivs:(OutterAndInnerDivs *)divs {
    ...
    divs.out_1 = FmtStr(@"<div %@ %@ %@></div>",
                        ...
                        _html_style(@"background-image: url(../../../images/decorateImages/点缀4.png); top: 0px;"));
}
