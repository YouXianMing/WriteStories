...
@implementation Paper_13

- (void)config_js_WithOutterAndInnerDivs:(OutterAndInnerDivs *)divs {
    
    divs.inner_2_class = @"pa h_100 w_100 z_n2 bsbb bss";
    divs.inner_2_style = @"-webkit-border-image: url(../../../images/edgePatternImages/典雅13.png) 320 294 314 292 repeat; border-width: 160px 147px 157px 146px;";
}
...
- (void)config_htmlString_WithOutterAndInnerDivs:(OutterAndInnerDivs *)divs {
    ...
    divs.inner_2 = FmtStr(@"<div %@ %@ %@></div>",
                          ...
                          _html_style(@"-webkit-border-image: url(../../../images/edgePatternImages/典雅13.png) 320 294 314 292 repeat; border-width: 160px 147px 157px 146px;"));
}
