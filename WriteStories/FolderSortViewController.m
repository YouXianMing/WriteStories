...
@interface FolderSortViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation FolderSortViewController
...
- (void)viewDidLoad {
    ...
    [self.folderItems enumerateObjectsUsingBlock:^(BaseFolderItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        
        [self.adapters addObject:[FolderSortCell dataAdapterWithData:obj]];
    }];
    ...
    [FolderSortCell registerToTableView:self.tableView];
}
