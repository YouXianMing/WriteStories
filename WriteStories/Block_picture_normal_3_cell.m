...
- (void)buildSubview {
    ...
    self.pictureView               = [[UIImageView alloc] initWithFrame:CGRectMake(15, 5.f + 20.f, App.Width - 30.f, 150.f)];
    self.pictureView.contentMode   = UIViewContentModeScaleAspectFill;
    self.pictureView.image         = [UIImage imageNamed:@"styles_jpeg"];
    self.pictureView.clipsToBounds = YES;
    [self.contentView addSubview:self.pictureView];
    
    UILabel *label      = [[UILabel alloc] initWithFrame:CGRectMake(0, 5, App.Width, 15)];
    label.text          = @"图片描述信息";
