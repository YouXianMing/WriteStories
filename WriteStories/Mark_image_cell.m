...
#import "Mark_image_cell.h"
#import "Mark_image.h"

@interface Mark_image_cell ()
...
@implementation Mark_image_cell
...
- (void)buildSubview {
    ...
    self.colorView.backgroundColor = [[UIColor blueColor] colorWithAlphaComponent:0.5f];
    [self.showContentView addSubview:self.colorView];
...
- (void)loadContent {
    ...
    // 蒙版
    self.colorView.alpha           = model.coverViewAlpha.floatValue;
    self.colorView.backgroundColor = [UIColor colorWithHexString:model.coverViewColorHex];
